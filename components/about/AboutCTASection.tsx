    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl px-6 md:px-10 lg:px-16 text-center">
          ...
          >
            Start with better conversations. Grow into clearer work
          </h2>

          {/* ── Sub-copy ── */}
          <p className="atc-anim-2 text-[15px] leading-[1.75] max-w-[700px] mx-auto mb-10" style={{ color: "#c2c4e0" }}>
            Use Sema for secure messaging, audio calls, video meetings, AI summaries
            and team collaboration. Connect to ZoikoTime when your organization needs
            communication to become verified workforce context.
          </p>
