    ...
    <>
      ...
      >
        <div className="mx-auto w-full max-w-3xl px-6 md:px-10 text-center">
          ...
          >
            <button className="aups-btn-primary text-white text-[14px] font-semibold rounded-full px-7 py-3">
              View Pricing
            </button>
            <button className="aups-btn-secondary bg-white text-gray-900 text-[14px] font-semibold rounded-full px-7 py-3">
              Contact Us
            </button>
          </div>
