    ...
    <div id="contact" className="w-full bg-indigo-700 flex justify-center py-20 px-8 lg:px-12">
      <div className="w-full max-w-[1000px] flex flex-col items-center gap-10">
        <div className="w-full max-w-[900px] flex flex-col items-center text-center gap-4">
          <h2 className="text-white text-4xl sm:text-5xl font-bold font-sans leading-[1.2]">
            Contact Support
          </h2>
          <p className="text-white/80 text-base sm:text-lg font-normal font-sans leading-6 max-w-[600px]">
        ...
        <div className="w-full max-w-[900px] bg-white rounded-3xl p-8 sm:p-10 shadow-2xl flex flex-col gap-8 relative overflow-hidden">
          <div className="w-full flex flex-col sm:flex-row gap-6">
            <div className="flex-1 flex flex-col gap-2">
              <label className="text-zinc-900 text-base font-normal font-sans leading-6">
                Product Area
              </label>
              <div className="relative">
                <select className="w-full h-12 pl-3 pr-10 py-2 bg-white rounded-lg border border-neutral-300 text-zinc-900 text-base font-normal font-sans appearance-none focus:outline-none focus:ring-2 focus:ring-sky-500">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <input 
              ...
              className="w-full h-12 px-3 py-3 bg-white rounded-lg border border-neutral-300 text-zinc-900 text-base font-normal font-sans placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500"
            />
          </div>
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <textarea 
              ...
              className="w-full px-3 py-3 h-32 bg-white rounded-lg border border-neutral-300 text-zinc-900 text-base font-normal font-sans placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
            ></textarea>
          </div>
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <textarea 
              ...
              className="w-full px-3 py-3 h-24 bg-white rounded-lg border border-neutral-300 text-zinc-900 text-base font-normal font-sans placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500 resize-y"
            ></textarea>
          </div>
          ...
          <div className="w-full pt-6 border-t border-neutral-300 flex flex-col sm:flex-row justify-between sm:items-center gap-6">
            <div className="flex items-center gap-4">
              <button type="button" className="flex items-center gap-2 text-zinc-700 hover:text-sky-700 transition-colors">
                ...
                <span className="text-base font-normal font-sans leading-6">Attach Files</span>
              </button>
              <span className="text-zinc-500 text-sm font-normal font-sans">Max size 20MB</span>
            </div>
            ...
            <button type="button" className="px-10 py-3.5 bg-sky-700 hover:bg-sky-800 transition-colors rounded-lg flex justify-center items-center">
              <span className="text-white text-base font-bold font-sans leading-6">Submit Ticket</span>
            </button>
          </div>
        </div>
      </div>
