      ...
      <div className="w-full max-w-[1280px] px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 items-start">
        <div className="flex-1 flex flex-col justify-start items-start gap-8">
          <div className="flex flex-col justify-start items-start">
            <h2 className="text-black text-4xl sm:text-5xl font-bold font-['Hanken_Grotesk'] leading-[1.1]">
          ...
          <div className="w-full py-4 border-t border-b border-neutral-300/30 flex flex-wrap justify-start items-center gap-6">
            <div className="flex justify-start items-center gap-2">
              ...
              <span className="text-zinc-700 text-sm sm:text-base font-normal font-['Hanken_Grotesk'] leading-6">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-8">
            <div className="w-full p-6 bg-gray-100 rounded-xl border-l-4 border-sky-700 flex flex-col justify-start items-start gap-2">
              <span className="text-sky-700 text-sm sm:text-base font-bold font-['Hanken_Grotesk'] uppercase leading-6">
                BEFORE YOU BEGIN
              </span>
              <p className="text-zinc-700 text-sm sm:text-base font-normal font-['Inter'] leading-6">
            ...
            <div className="w-full flex flex-col justify-start items-start gap-6">
              <div className="w-full flex justify-start items-start gap-4">
                <div className="w-8 h-8 shrink-0 bg-black rounded-full flex justify-center items-center mt-0.5">
                  <span className="text-white text-base font-bold font-['Inter'] leading-6">1</span>
                </div>
                <div className="flex-1 flex flex-col justify-start items-start gap-2">
                  <h4 className="text-zinc-900 text-base font-semibold font-['Inter'] leading-6">
              ...
              <div className="w-full flex justify-start items-start gap-4">
                <div className="w-8 h-8 shrink-0 bg-black rounded-full flex justify-center items-center mt-0.5">
                  <span className="text-white text-base font-bold font-['Inter'] leading-6">2</span>
                </div>
                <div className="flex-1 flex flex-col justify-start items-start gap-2">
                  <h4 className="text-zinc-900 text-base font-semibold font-['Inter'] leading-6">
                  ...
                  <div className="w-full mt-2 rounded-xl border border-neutral-300 shadow-sm overflow-hidden flex flex-col">
                    ...
                    <div className="w-full p-3 bg-zinc-50 flex justify-center items-center">
                      <span className="text-zinc-500 text-xs font-medium font-['Inter'] leading-4">
            ...
            <div className="w-full p-6 bg-green-50 rounded-xl border border-green-200 flex flex-col justify-start items-start gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-700 text-base font-bold font-['Hanken_Grotesk'] uppercase leading-6">
                  EXPECTED RESULT
                </span>
              </div>
              <p className="text-green-800 text-base font-normal font-['Inter'] leading-6">
            ...
            <div className="w-full pt-8 border-t border-neutral-300 flex flex-col items-start gap-4">
              <h3 className="text-zinc-900 text-xl font-semibold font-['Inter'] leading-7">
              ...
              <div className="flex justify-start items-center gap-3">
                <button className="px-4 py-2 rounded-lg border border-neutral-300 hover:bg-neutral-50 transition-colors flex items-center gap-2">
                  ...
                  <span className="text-zinc-900 text-sm font-medium font-['Inter']">Yes</span>
                </button>
                <button className="px-4 py-2 rounded-lg border border-neutral-300 hover:bg-neutral-50 transition-colors flex items-center gap-2">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-zinc-900 text-sm font-medium font-['Inter']">No</span>
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-72 flex flex-col gap-12 shrink-0">
          <div className="w-full p-8 bg-slate-900 rounded-2xl flex flex-col gap-4">
            <h3 className="text-white text-2xl font-semibold font-['Hanken_Grotesk'] leading-8">
              Still need help?
            </h3>
            <p className="text-slate-400 text-base font-normal font-['Inter'] leading-6 pb-4">
            ...
            >
              <span className="text-white text-base font-semibold font-['Hanken_Grotesk']">
                Contact Support
              </span>
            </a>
          </div>
          ...
          <div className="w-full flex flex-col gap-6">
            <h4 className="text-zinc-500 text-sm font-bold font-['Hanken_Grotesk'] uppercase tracking-wide">
              RELATED ARTICLES
            </h4>
            <div className="flex flex-col gap-4">
              <a href="#" className="text-sky-700 hover:underline text-base font-medium font-['Inter'] leading-6">
