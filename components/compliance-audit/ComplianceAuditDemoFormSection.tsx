...
const USE_CASE_OPTIONS = [
  ...
  { value: "decision-tracking", label: "Decision tracking" },
  { value: "export-evidence", label: "Export & evidence packs" },
...
export default function ComplianceAuditDemoFormSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTouched({ workEmail: true, company: true, agree: true });
  ...
  return (
    <>
      <style>{`
        ...
        .ca-demo-hidden { opacity: 0; transform: translateY(24px); }
        .ca-demo-visible { animation: caDemoUp .55s cubic-bezier(.22,1,.36,1) forwards; }

        .ca-demo-check-item { opacity: 0; transform: translateX(-14px); }
        .ca-demo-check-item.active { animation: caDemoCheckIn .45s cubic-bezier(.22,1,.36,1) forwards; }
        @keyframes caDemoCheckIn {
        ...
        .ca-demo-btn:hover:not(:disabled) {
          transform: translateY(-2px);
          box-shadow: 0 14px 28px rgba(79,99,240,0.4);
          background: #3E51DE;
        }
        .ca-demo-btn:disabled { opacity: 0.6; cursor: not-allowed; }

        .ca-demo-check { accent-color: #4F63F0; }

        @media (prefers-reduced-motion: reduce) {
          .ca-demo-hidden, .ca-demo-check-item { opacity: 1 !important; transform: none !important; animation: none !important; }
          .ca-demo-visible { animation: none !important; }
          .ca-demo-btn:hover { transform: none !important; }
        }
      `}</style>

      <section id="request-demo" className="bg-[#F3F2FD] px-6 py-16 sm:px-10 lg:px-16">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-start gap-10 lg:grid-cols-2">
          {/* Left copy */}
          <div ref={leftRef} className={`ca-demo-hidden ${leftIn ? "ca-demo-visible" : ""}`}>
            <p className="mb-4 text-xs font-semibold uppercase tracking-[2px] text-[#4F63F0]">
              Enterprise demo
            </p>
            ...
            <p className="mt-5 max-w-md text-sm leading-relaxed text-gray-500">
              Walk through capture, review, exception handling, sync, and
              permissioned export with our team.
            </p>
            ...
            <div className="mt-7 flex flex-col gap-2.5">
              {checklist.map((item, i) => (
                <div
                  key={item}
                  className={`ca-demo-check-item ${leftIn ? "active" : ""} flex items-start gap-2.5`}
                  style={{ animationDelay: `${300 + i * 90}ms` }}
                >
                  <span
                    className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full"
                    style={{ background: "#4F63F0" }}
                  >
                  ...
                  <p className="text-[13.5px] leading-snug text-gray-700">{item}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div
            ref={formRef}
            className={`ca-demo-hidden ${formIn ? "ca-demo-visible" : ""} overflow-hidden rounded-2xl bg-white shadow-[0_20px_50px_rgba(15,15,42,0.08)]`}
            style={{ animationDelay: "0.1s" }}
          >
            <div className="flex items-center justify-between bg-[#0B1330] px-6 py-4 sm:px-7">
              <h3 className="text-sm font-bold text-white">Request a demo</h3>
              <span className="rounded-full bg-[#4F63F0]/20 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-[#8FA3FF]">
                Enterprise
              </span>
            </div>
              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} noValidate>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      <label htmlFor="ca-work-email" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                        Work email
                      </label>
                      <input
                        id="ca-work-email"
                    ...
                    <div>
                      <label htmlFor="ca-company" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                        Company
                      </label>
                      <input
                        id="ca-company"
                    ...
                    <div>
                      <label htmlFor="ca-role" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                        Role
                      </label>
                      <input
                        id="ca-role"
                    ...
                    <div>
                      <label htmlFor="ca-team-size" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                        Team size
                      </label>
                      <input
                        id="ca-team-size"
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="ca-use-case" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                        Use case
                      </label>
                      <select
                        id="ca-use-case"
                        ...
                        className={`${inputBase} border-gray-200`}
                      >
                        <option value="">Select a ZoikoTime topic...</option>
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="ca-tools" className="mb-1.5 block text-[12.5px] font-semibold text-gray-900">
                      ...
                      <input
                        ...
                        placeholder="Meetings, tasks, CRM..."
                        className={`${inputBase} border-gray-200`}
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="ca-demo-btn mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl py-3.5 text-[14px] font-semibold text-white"
                  >
                  ...
                  <p className="mt-3 flex items-center justify-center gap-1.5 text-center text-[11.5px] text-gray-400">
                    <Shield size={12} strokeWidth={2} className="text-[#4F63F0]" />
