          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-[1136px] mx-auto w-full">
            ...
            <div className={`lg:col-span-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/20 p-8 flex flex-col justify-center space-y-8 transition-all duration-1000 delay-300 transform ${protectedVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'} hover:border-white/30 transition-colors`}>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-2">
                <a href="/meeting-to-work" className="px-6 py-3 cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs rounded-full shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 text-center inline-flex items-center justify-center">
                  Start a confidential meeting
                </a>
                <a href="/messaging" className="px-6 py-3 cursor-pointer border border-white/30 hover:border-white/60 hover:bg-white/5 text-white font-semibold text-xs rounded-full transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 text-center inline-flex items-center justify-center">
