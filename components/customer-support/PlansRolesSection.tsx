...
export default function PlansRolesSection() {
  ...
  const tiers = [
    {
      name: "Free",
      description: "Internal support space, basic messages, meetings, tasks, and files.",
      features: [
    ...
    {
      name: "Team",
      description: "Shared queues, templates, guests, team reporting, and connected customer spaces.",
      features: [
    ...
    {
      name: "Business",
      description: "SSO, advanced routing, retention, full audit, integrations, AI governance, and exports.",
      features: [
        "SSO and MFA",
    ...
    {
      name: "Enterprise",
      description: "Custom roles, sensitive-case controls, legal hold, advanced integrations, and deployment support.",
      features: [
          ...
          {tiers.map((tier, idx) => (
            ...
            >
              ...
              <div className="space-y-4 flex-1 flex flex-col">
                <div className="space-y-1.5">
                  ...
                  <p className={`text-xs font-normal  leading-relaxed ${
                    tier.isPopular ? 'text-slate-300' : 'text-gray-500 dark:text-gray-400'
                  }`}>
                    {tier.description}
                  </p>
                </div>
                  ...
                  {tier.features.map((feature, fIdx) => (
                    <div key={fIdx} className="flex items-start gap-2.5 group/item">
                      <div className="pt-0.5 shrink-0 text-teal-500 dark:text-teal-400">
                        <Check className="size-3.5 transition-transform group-hover/item:scale-110" strokeWidth={3} />
                      </div>
                      <span className={`text-xs font-normal  leading-tight ${
                        tier.isPopular ? 'text-slate-200' : 'text-gray-700 dark:text-gray-300'
                      }`}>
                        {feature}
                      </span>
                    </div>
              ...
              <div className="mt-6 pt-2">
                <button className={`w-full py-2.5 rounded-full text-center text-sm font-bold  leading-5 transition-all duration-200 active:scale-98 ${
                  tier.isPopular
