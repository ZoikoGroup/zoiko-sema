        ...
        <div className="w-[1200px] max-w-[1280px] left-[120px] top-[72px] absolute inline-flex justify-center items-center gap-16">
            <div className="flex-1 pt-px inline-flex flex-col justify-start items-start gap-6">
                <div className="px-4 py-1 bg-indigo-700/10 rounded-full inline-flex justify-start items-start">
                    <div className="justify-center text-indigo-700 text-xs font-semibold font-['Hanken_Grotesk'] leading-4 tracking-wide">REVENUE GOVERNANCE PLATFORM</div>
                </div>
                <div className="self-stretch flex flex-col justify-start items-start">
                    <div className="self-stretch justify-center text-black text-5xl font-bold font-['Hanken_Grotesk'] leading-[60px]">One governed workspace<br/>for every customer<br/>conversation.</div>
                </div>
                <div className="w-full max-w-[576px] flex flex-col justify-start items-start">
                    <div className="self-stretch justify-center text-zinc-700 text-base font-normal font-['Hanken_Grotesk'] leading-6">Show how Zoiko Sema connects account discussions, meetings, reviewed AI<br/>summaries, customer commitments, internal tasks, and deal collaboration<br/>inside one secure workspace.</div>
                </div>
                <div className="self-stretch pt-10 flex flex-col justify-start items-start gap-6">
                    <button className="px-16 py-6 relative bg-indigo-700 rounded-lg flex flex-col justify-center items-center hover:bg-indigo-800 transition-colors">
                        ...
                        <div className="text-center justify-center text-white text-base font-normal font-['Hanken_Grotesk'] leading-6">Enable My Sales Team</div>
                    </button>
                </div>
            </div>
