        ...
        <div className="w-[1200px] pt-16 left-[120px] top-[72px] absolute inline-flex justify-start items-center gap-16">
            <div className="w-96 inline-flex flex-col justify-start items-start gap-6">
                <div className="self-stretch flex flex-col justify-start items-start">
                    <div className="self-stretch justify-center text-zinc-900 text-3xl font-semibold font-['Hanken_Grotesk'] leading-10">Shared Deal Rooms</div>
                </div>
                <div className="self-stretch flex flex-col justify-start items-start">
                    <div className="self-stretch justify-center text-zinc-700 text-base font-normal font-['Hanken_Grotesk'] leading-6">A single source of truth for you and your prospects.<br/>No more hunting through email threads.</div>
                </div>
                <div className="self-stretch pt-4 flex flex-col justify-start items-start gap-4">
                    <div className="self-stretch inline-flex justify-start items-center gap-4">
                        ...
                        <div className="inline-flex flex-col justify-start items-start">
                            <div className="justify-center text-zinc-900 text-base font-bold font-['Hanken_Grotesk'] leading-6">Automated Expiration Controls</div>
                        </div>
                    </div>
                    <div className="self-stretch inline-flex justify-start items-center gap-4">
                        <div className="inline-flex flex-col justify-start items-start">
                        ...
                        <div className="inline-flex flex-col justify-start items-start">
                            <div className="justify-center text-zinc-900 text-base font-bold font-['Hanken_Grotesk'] leading-6">Participant Verification</div>
                        </div>
                    </div>
                    <div className="self-stretch inline-flex justify-start items-center gap-4">
                        <div className="inline-flex flex-col justify-start items-start">
                        ...
                        <div className="inline-flex flex-col justify-start items-start">
                            <div className="justify-center text-zinc-900 text-base font-bold font-['Hanken_Grotesk'] leading-6">Full Audit History</div>
                        </div>
                    </div>
                </div>
            </div>
