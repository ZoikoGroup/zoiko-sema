    ...
    <>
      ...
      >
        <div className="mx-auto w-full max-w-3xl px-6 md:px-10 text-center">
          ...
          >
            <Link href="/pricing" className="sps-btn-primary inline-flex items-center justify-center text-white text-[14px] font-semibold rounded-full px-7 py-3">
              View Pricing
            </Link>
            <Link href="/contact" className="sps-btn-secondary inline-flex items-center justify-center bg-white text-gray-900 text-[14px] font-semibold rounded-full px-7 py-3">
              Contact Us
            </Link>
          </div>
